  ...
  return (
    <div>
      ...
      <div className=' h-[40vh] bg-white'>
          ...
          <footer>
    <div className=" opacity-70 py-4 text-gray-600">
      <div className="container md:px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between text-white">
          ...
          <div className="md:px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              <li><Link to="#" className="hover:text-blue-400">Getting Started With HTML and CSS</Link></li>
              <li><Link to="#" className="hover:text-blue-400">What Is Flex And When to Use It?</Link></li>
              <li><Link to="#" className="hover:text-blue-400">How TailwindCSS Can Help Your Productivity?</Link></li>
              <li><Link to="#" className="hover:text-blue-400">5 Tips to Make Responsive Website</Link></li>
